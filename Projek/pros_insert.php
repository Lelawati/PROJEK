<html>
 ...
 #navbar>li
	...
	<tr>
		<td>E-MAIL PESERTA</td><td>:</td><td> <input type="text" name="email" required><br><br></td>
	</tr>
	<tr>
		<td>NO TEL</td><td>:</td><td> <input type="text" name="notelefon" required><br><br></td>
	</tr>
	<tr>
...
<!--memproses input yang dimasukkan ke dalam pangkalan data-->
<?php
	include('config.php');
	...
	$add=mysqli_query($connect, "INSERT INTO peserta values ('$nama_peserta','$email','$notelefon','$slot')");
